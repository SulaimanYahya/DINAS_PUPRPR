<?php
class Format3pdf extends CI_Controller
{
    ...
    function cetak($kode)
    {
        ...
        $get_spm = $this->db->get_where('tb_format3', ['kode_spm' => $kode])->row_array();
        ...
        $pegawai_empat = $this->db->get_where('tb_pegawai', ['id' => $id_ppk])->row_array();
        $pegawai_lima = $this->db->get_where('tb_pegawai', ['id' => $id_pptk])->row_array();
        ...
        $pdf->MultiCell(0, 6, 'Demikian Surat Pernyataan ini dibuat untuk melengkapi persyaratan pengajuan SPM-' . $get_spm['jenis_spm'] . ' SKPD Kami.', 0);
        $pdf->Cell(10, 6, '', 0, 1);
        $pdf->SetFont('Arial', '', 10);
        ...
        $table->easyCell("");
        $table->easyCell($pegawai_lima['nama'], 'align:C; font-style:BU; font-size:7');
        $table->easyCell("");
        $table->easyCell("");
        $table->easyCell("");
        $table->easyCell("");
        ...
        $table->easyCell("");
        $table->easyCell("NIP." . $pegawai_lima['nip'], 'align:C; font-size:7');
        $table->easyCell("");
        $table->easyCell("");
        $table->easyCell("");
        $table->easyCell("");
        ...
        $pdf->Cell(30, 5, 'Jabatan', 0, 0);
        $pdf->Cell(5, 5, ':', 0, 0);
        $pdf->Cell(50, 5, 'PEJABAT PELAKSANA TEKNIS KEGIATAN (PPTK)', 0, 1);
        $pdf->Cell(10, 3, '', 0, 1);
        ...
        $pdf->Cell(120, 5, 'PEJABAT PELAKSANA TEKNIS KEGIATAN / ' . $pegawai_lima['nama'], 'LTR', 0);
        $pdf->Cell(39, 5, '', 'LTR', 1, 'C');
        ...
        $pdf->Cell(15, 6, '', 0, 0);
        $pdf->Cell(5, 6, '2.', 0, 0);
        $pdf->MultiCell(0, 6, 'Jumlah Belanja ' . $jenis_blnja . ' (' . $get_spm['jenis_spm'] . ') tersebut di atas akan dipergunakan untuk keperluan membiayai kegiatan yang akan kami laksanakan sesuai DPA-SKPD', 0);
        $pdf->Cell(15, 6, '', 0, 0);
        $pdf->Cell(5, 6, '3.', 0, 0);
