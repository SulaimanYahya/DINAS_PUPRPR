            ...
            <div class="col-lg-7">
              ...
              <div class="card">
                    <div class="card-header text-white gradient-status">
                        <a href="<?= base_url('bidang');?>" class="btn btn-warning btn-icon-split">
                    ...
                    <div class="row">
            <div class="col-lg-12">
            <?php echo form_open_multipart('bidang/edit_proses');?>

              <div class="form-group row">
                <label for="nama" class="col-sm-3 col-form-label">Nama Bidang</label>
                <div class="col-sm-9">
                  <input type="hidden" class="form-control" name="id_bidang" value="<?= $bidang_data['id_bidang'];?>">
                <input type="text" class="form-control" name="nama_bidang" value="<?= $bidang_data['nama_bidang'];?>" required>
                </div>
              </div>
