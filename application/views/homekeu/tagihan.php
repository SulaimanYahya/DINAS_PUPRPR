                                ...
                                <tr>
                                    <td>
                                        <form class="form-inline" method="post" action="format_tagihan">
                                            ...
                                            <a href="<?= base_url('tagihan/' . enkrip($i['id_belanja']) . '/' . enkrip($tagihan_data['id_jenis_program']) . '/' . enkrip($tagihan_data['id_jenis_kegiatan']) . '/' . enkrip($tagihan_data['id_jenis_sub_kegiatan'])) ?>" class="btn btn-primary btn-sm"><i class="fas fa-hand-holding-usd"></i></a>
