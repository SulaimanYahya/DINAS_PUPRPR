...
<body id="page-top">
					...
					<tbody>
						...
						<?php foreach ($data as $r) : ?>
							<tr>
								...
								<td><?= number_format($r->jml_honor_perbulan) ?></td>
								<td><?= number_format($r->jml_honor) ?></td>
								<td><?= number_format($r->pph_pasal21) ?></td>
								<td><?= number_format($r->jml_diterima) ?></td>
								<td><?= $r->ket . ' Bulan' ?></td>
								<td>
									<a href="<?= base_url('Lampiran/delete/lamp4/' . enkrip($r->id)) ?>" class="text-decoration-none badge badge-danger" data-toggle="tooltip" data-placement="top" title="Hapus Data">
			...
			<div class="modal fade" id="cetak" tabindex="-1" aria-labelledby="cetakLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg">
					<div class="modal-content">
						...
						<form method="POST" action="<?= base_url('L_Format4') ?>" target="_blank">
							<input type="hidden" name="id_belanjax" id="inputData" value="">
							<div class="modal-body">
								<div class="form-group row">
									<label for="Tanggal Pembuatan" class="col-sm-4 col-form-label">Tanggal Pembuatan</label>
									<div class="col-sm-8">
										<input type="date" class="form-control form-control-sm" id="tgl_pembuatan" name="tgl_pembuatan">
									</div>
								</div>
								<hr>
								<div class="form-group row">
									<label for="selang_bulan" class="col-sm-2 col-form-label">Selang Bulan</label>
									<div class="col-sm-4">
								...
								<div class="form-group row">
									<label for="penjabat_pembuat_komite" class="col-sm-4 col-form-label">Pejabat Pembuat Komite</label>
									<div class="col-sm-8">

										<select class="form-control form-control-sm" name="pejabat_pembuat_komite" id="pejabat_pembuat_komite">
									...
									<label for="bendahara_pengeluaran" class="col-sm-4 col-form-label">Bendahara Pengeluaran</label>
									<div class="col-sm-8">

										<select class="form-control form-control-sm" name="bendahara_pengeluaran" id="bendahara_pengeluaran">
											<option value="">-Pilih-</option>
											<?php $i = 1; ?>
											<?php foreach ($pegawai as $r) : ?>
												<option value="<?= $r->id ?>"><?= $i++ . '. ' . $r->nama ?></option>
			...
			<div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="tambahDataLabel" aria-hidden="true">
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						...
						<form id="pjuForm" method="POST" action="<?= base_url('Lampiran/insert/lamp4') ?>">
							<div class="modal-body">
								<div class="form-group row">
								...
								<div class="form-group row">
									<label for="jml_honor_perbulan" class="col-sm-4 col-form-label">Honor Perbulan</label>
									<div class="col-sm-8 row">
										<input type="text" class="form-control form-control-sm" name="jml_honor_perbulan" id="jml_honor_perbulan">
									</div>
								</div>
								<div class="form-group row">
									<label for="ket" class="col-sm-4 col-form-label">Keterangan / Bulan</label>
									<div class="col-sm-8 row">
										<input type="text" class="form-control form-control-sm" name="ket" id="ket">
									</div>
								</div>
								<div class="form-group row">
									<label for="jml_honor" class="col-sm-4 col-form-label">Jumlah Honor</label>
									<div class="col-sm-8 row">
										<input type="text" min="1" class="form-control form-control-sm" name="jml_honor" id="jml_honor" readonly>
									</div>
								</div>
								<div class="form-group row">
									<label for="pph_pasal21" class="col-sm-4 col-form-label">PPH Pasal 21</label>
									<div class="col-sm-8 row">
										<input type="text" class="form-control form-control-sm" name="pph_pasal21" id="pph_pasal21">
									</div>
								</div>
								<div class="form-group row">
									<label for="jml_diterima" class="col-sm-4 col-form-label">Jumlah Diterima</label>
									<div class="col-sm-8 row">
										<input type="text" class="form-control form-control-sm" name="jml_diterima" id="jml_diterima" value="0" readonly>
									</div>
								</div>
							</div>
							<div class="modal-footer">
					...
					<div class="modal-content">
						...
						<form id="pjuForm" method="POST" action="<?= base_url('Lampiran/insert/lamp2') ?>">
							<div class="modal-body">
								...
								<div class="form-group row">
									<label for="jml_honor_perbulan" class="col-sm-2 col-form-label">Honor Perbulan</label>
									<div class="col-sm-10 row">
										<input type="text" class="form-control form-control-sm" name="jml_honor_perbulan" id="jml_honor_perbulan">
									</div>
								</div>
								<div class="form-group row">
									<label for="ket" class="col-sm-2 col-form-label">Keterangan (bulan)</label>
									<div class="col-sm-10 row">
										<input type="text" class="form-control form-control-sm" name="ket" id="ket" value="0" readonly>
									</div>
								</div>
								<div class="form-group row">
									<label for="jml_honor" class="col-sm-2 col-form-label">Jumlah Honor</label>
									<div class="col-sm-10 row">
										<input type="text" min="1" class="form-control form-control-sm" name="jml_honor" id="jml_honor">
									</div>
								</div>
								<div class="form-group row">
									<label for="pph_pasal21" class="col-sm-2 col-form-label">PPH Pasal 21</label>
									<div class="col-sm-10 row">
										<input type="text" class="form-control form-control-sm" name="pph_pasal21" id="pph_pasal21" value="0">
									</div>
								</div>
								<div class="form-group row">
									<label for="jml_diterima" class="col-sm-2 col-form-label">Jumlah Diterima</label>
									<div class="col-sm-10 row">
										<input type="text" class="form-control form-control-sm" name="jml_diterima" id="jml_diterima" value="0" readonly>
									</div>
								</div>
	...
	<script>
		...
		function formatAndCalculate() {
			// TAMBAH
			const jml_honor_perbulan = document.getElementById("jml_honor_perbulan");
			const ket = document.getElementById("ket");
			const jml_honor = document.getElementById("jml_honor");
			const pph_pasal21 = document.getElementById("pph_pasal21");
			const jml_diterima = document.getElementById("jml_diterima");
			...
			function calculate() {
				const jml_honor_perbln = parseFloat(jml_honor_perbulan.value.replace(/\,/g, "")) || 0;
				const bulan = parseFloat(ket.value.replace(/\,/g, "")) || 0;

				// Mengalikan jml_honor_perbulan dengan ket
				const result = jml_honor_perbln * bulan;

				jml_honor.value = result.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");

				// Menghitung jumlah diterima (jml_honor dikurangi pph_pasal21)
				const pph = parseFloat(pph_pasal21.value.replace(/\,/g, "")) || 0;
				const jumlahDiterima = result - pph;

				jml_diterima.value = jumlahDiterima.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",");
			}

			jml_honor_perbulan.addEventListener("input", function() {
				formatNumber(jml_honor_perbulan);
				calculate();
			});
			...
			pph_pasal21.addEventListener("input", function() {
				formatNumber(pph_pasal21);
				calculate();
			});
		}
