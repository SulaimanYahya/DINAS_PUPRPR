            ...
            <div class="col-lg-12">
              ...
              <div class="card">
                    <div class="card-header text-primary gradient-status">
                        <form class="form-inline" method="post" action="LaporanExcel">
                        <button type="submit" class="btn btn-primary mb-2"><i class="fas fa-fw fa-download"></i>&nbsp; Export Laporan Excel</button>
                      </form>
                    </div>
                    <div class="card-body">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><a href="" class="badge <?php if ($i['status_mhs']=='tunggu') {
                                          ...
                                          ?>"><?= $i['status_mhs'];?></a></td>
                            <td>
                                <a href="<?= base_url('laporan/validasi/'). $i['nim'];?>" class="btn btn-success btn-sm btn-icon-split" onclick="return confirm('apakah anda telah meng-export file excel data mahasiswa? Jika mahasiswa ini tidak dibutuhkan pada laporan, maka lanjutkan validasi, setelah di validasi mahasiswa akan hilang dari tampilan laporan. Apakah anda yakin?');"><span class="icon text-white-50">
