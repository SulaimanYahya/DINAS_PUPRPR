            ...
            <tbody>
              ...
              <?php foreach ($program as $i) : ?>
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?= base_url('renja/validasi_program/') . $i['id_target_program']; ?>" class="btn btn-warning btn-sm btn-icon-split" onclick="return confirm('yakin ambil program ke renja awal?');"><span class="icon text-white">
