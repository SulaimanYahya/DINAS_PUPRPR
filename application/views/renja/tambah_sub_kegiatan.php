              ...
              <div class="card">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <a href="<?= base_url('renja/validasi_sub_kegiatan/'). $i['id_target_sub'];?>" class="btn btn-warning btn-sm btn-icon-split" onclick="return confirm('yakin ambil sub kegiatan ke renja awal?');"><span class="icon text-white">
