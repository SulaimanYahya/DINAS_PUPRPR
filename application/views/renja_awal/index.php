            ...
            <div class="col-lg-12">
              ...
              <div class="card">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th scope="row"><a href="<?= base_url('renja_awal/tambah_program/'). $i['id_sasaran'];?>"><i class="fas fa-fw fa-forward"></i></a></th>
              ...
              <div class="card">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <th scope="row"><a href="<?= base_url('renja_awal/tambah_kegiatan/'). $i['id_program'];?>"><i class="fas fa-fw fa-forward"></i></a></th>
                        <td><?= $i['nama_jenis_sasaran'];?></td>
            ...
            <div class="col-lg-12">
              ...
              <div class="card">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th scope="row"><a href="<?= base_url('renja_awal/tambah_sub_kegiatan/'). $i['id_kegiatan'];?>"><i class="fas fa-fw fa-forward"></i></a></th>
                        <td><?= $i['nama_jenis_sasaran'];?></td>
                        <td><?= $i['nama_jenis_program'];?></td>
