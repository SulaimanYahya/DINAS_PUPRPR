              ...
              <div class="card">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                            <a href="<?= base_url('renja_awal/validasi_kegiatan/'). $i['id_target_kegiatan'];?>" class="btn btn-warning btn-sm btn-icon-split" onclick="return confirm('yakin ambil kegiatan ke renja awal?');"><span class="icon text-white">
