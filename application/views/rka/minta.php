            ...
            <div class="col-lg-12">
              ...
              <div class="card">
                    <div class="card-header text-primary gradient-card">
                      <form class="form-inline" method="post" action="minta_tahun">
                    ...
                    <tbody>
                      ...
                      <tr>
                       <th scope="row"><?= $no; ?></th>
                        ...
                        <td><?= $i['rk_tahun'];?></td>
                        <td><?= number_format($i['rk_target_anggaran']);?></td>
                        <td><?= number_format($i['rk_target_fisik']);?></td>
                      </tr>
            ...
            <div class="col-lg-12">
              ...
              <div class="card">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th scope="row"><a href="<?= base_url('rka/minta_belanja/'). $i['id_renja_sub'];?>"><i class="fas fa-fw fa-forward"></i></a></th>
                        <td><?= $i['nama_jenis_sasaran'];?></td>
                        <td><?= $i['nama_jenis_program'];?></td>
                        <td><?= $i['nama_jenis_kegiatan'];?></td>
                        ...
                        <td><?= $i['rs_tahun'];?></td>
                        <td><?= number_format($i['rs_target_anggaran']);?></td>
                        <td><?= number_format($i['rs_target_fisik']);?></td>
                      </tr>
              ...
              <div class="card">
                    <div class="card-header text-primary gradient-card">
                        Rincian Belanja Tahun <?php 
                              date_default_timezone_set('Asia/Makassar');
                  echo $tahun_skrg;?>, Untuk Melihat Struktur Belanja Masuk Dari Sub Kegiatan >> 
                    </div>
                    <div class="card-body table-responsive">
