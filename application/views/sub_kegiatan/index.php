        ...
        <div class="container-fluid small">
              ...
              <div class="card">
                    <div class="card-header text-white gradient-status">
                        <a href="" class="btn btn-primary btn-icon-split" data-toggle="modal" data-target="#newDataModal"><span class="icon text-white-50">
                                              ...
                                              <span class="text">Tambah Sub Kegiatan</span></a> 
                    </div>
          ...
          <thead class="">
            <tr>
              ...
              <th scope="col" class="gradient-huruf">Nama Sub Kegiatan</th>
              <th scope="col" class="gradient-huruf">Action</th>
            </tr>
          </thead>
          <tbody>
            <?php $no = 1;?>
            <?php foreach ($jenis_sub_kegiatan as $i) : ?>

            <tr>
              <th scope="row"><?= $no;?></th>
              <td><?= $i['nama_jenis_sub_kegiatan'];?></td>
              <td>
                  <a href="<?= base_url('sub_kegiatan/edit/'). $i['id_jenis_sub_kegiatan'];?>" class="btn btn-warning btn-sm btn-icon-split"><span class="icon text-white-50">
                                    <i class="fas fa-fw fa-edit"></i>
                                </span></a>
                  <a href="<?= base_url('sub_kegiatan/hapus/'). $i['id_jenis_sub_kegiatan'];?>" class="btn btn-danger btn-sm btn-icon-split" onclick="return confirm('yakin hapus data?');"><span class="icon text-white-50">
    ...
    <div class="modal fade" id="newDataModal" tabindex="-1" role="dialog" aria-labelledby="newDataModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <?php echo form_open_multipart('sub_kegiatan/input');?>
          <div class="modal-body">

            <div class="form-group">
              <textarea type="text" class="form-control" placeholder="Nama Sub Kegiatan" name="nama_jenis_sub_kegiatan" required></textarea>
            </div>
