			...
			<?php foreach ($list as $r) : ?>
				<tr>
					...
					<td>
						...
						<a href="<?= base_url('Daftar_Tagihan/delete/' . enkrip($r->id) . '/F3') ?>" class="text-decoration-none badge badge-danger">Hapus</a>
						<a href="<?= base_url('Format3pdf/cetak/') . $r->kode_spm; ?>" class="text-decoration-none badge badge-secondary" target="_blank">Cetak</a>
					</td>
				</tr>
				<?php $no++; ?>
			<?php endforeach; ?>
