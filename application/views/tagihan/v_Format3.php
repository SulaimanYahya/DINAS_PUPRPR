<div class="container-fluid">
    ...
    <hr>
    <form method="POST" action="<?= base_url('Format3/simpan') ?>">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-4">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            <label for="no_sppls">Nomor SPP-LS</label>
                            <input type="text" class="form-control form-control-sm" id="no_sppls" name="no_sppls" placeholder="………../SPP-LS/DPUPRPR/2023" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group input-group-sm mb-2">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-sm" id="uraian3" name="sisa_angg1">
                                    <?php foreach ($belanja as $r) : ?>
                                        <option value="<?= $r->total ?>" data-chained="<?= enkrip($r->id_belanja) ?>"><?= masterGetId('total_kp_belanja', 'tb_kp_belanja', 'id_kp_belanja', $r->id_kp_belanja); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                <label for="Uraian">Jumlah yang diminta pada saat SPP ini</label>
                                <select class="form-control form-control-sm" id="uraian2" name="sisa_angg1">
                                    <?php foreach ($belanja as $r) : ?>
                                        <option value="<?= $r->total ?>" data-chained="<?= enkrip($r->id_belanja) ?>"><?= $r->total ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="jml_yg_diminta">Sisa Anggaran s/d SPP ini</label>
                            <div class="input-group input-group-sm mb-2">
                                <div class="input-group-prepend">
                                    <div class="input-group-text" id="inputGroup-sizing-sm">Rp.</div>
                                </div>
